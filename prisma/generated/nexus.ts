...
export interface NexusGenObjects {
  ...
  Transaction: { // root type
    ...
    creditedAccount?: NexusGenRootTypes['Account'] | null; // Account
    debitedAccount?: NexusGenRootTypes['Account'] | null; // Account
    id?: number | null; // Int
...
export interface NexusGenFieldTypes {
  ...
  Query: { // field return type
    ...
    getTransactions: Array<NexusGenRootTypes['Transaction'] | null> | null; // [Transaction]
  }
...
export interface NexusGenArgTypes {
  Mutation: {
    createTransaction: { // args
      creditedAccountUsername: string; // String!
      debitedAccountId: number; // Int!
      token: string; // String!
      value: number; // Float!
    }
    createUser: { // args
